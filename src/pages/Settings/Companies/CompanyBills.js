...
export default function CompanyBills({ id = 0 }) {
    ...
    const columns = [
        ...
        { name: 'Company', id: 'c.title', selector: row => row.company, sortable: true, pinned: 'left' },
        { name: 'Bill No', id: 'b.bill_no', selector: row => row.bill_no, sortable: true, hide: 'sm' },
    ...
    return (
        <>
            {console.log('Rendering CompanyBills with data:', data)}
            {!loading &&  (
                <>
