...
const ExpandedComponent = ({ data }) => (
    <div className="expanded-row-container">
        ...
        <p><strong>Summary:</strong>{data.details}</p>
...
export default function Events() {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            const response = await apiFetch({
                path: `/bill-manager/v1/events?${queryString}`,
            });
    ...
    const columns = [
        ...
        { name: 'Date', id: 'date', selector: row => row.date, sortable: true, hide: 'sm' },
        {
            name: 'Action',
            cell: (row) => (
    ...
    "type": "Email",
    "details": "",
    "created_at": "2026-08-17 11:36:05",
    "updated_at": "2026-08-17 11:36:05",
    "company_title": "Occaecat cupidatat non proident"
}
    */
