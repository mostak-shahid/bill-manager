...
export default function PersonCreateModal({ show, setShow, setReloadTable }) {
        ...
        <>
            ...
            <Modal size="lg" show={show} onHide={handleClose}>
                <Modal.Header closeButton>
                    <Modal.Title>{__('Add Person', 'bill-manager')}</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    ...
                    <Form noValidate validated={validated} onSubmit={handleSubmit}>
                        ...
                        <Row>
                            ...
                            <Col md={6}>
                                <FloatingLabel
                                    ...
                                    label={__('Designation', 'bill-manager')}
                                    className="mb-3"
                                >
                                    <Form.Control
                                        type="text"
                                        placeholder={__('Designation', 'bill-manager')}
                                        value={designation}
                        ...
                        <Row>
                            ...
                            <Col md={6}>
                                <FloatingLabel
                                    controlId="email"
                                    label={__('Email', 'bill-manager')}
                                    className="mb-3"
                                >
                                    <Form.Control
                                        type="email"
                                        placeholder={__('Email', 'bill-manager')}
                                        value={email}
